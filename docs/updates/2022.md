...
* [**interface**](https://github.com/AnimeSwap/interface) add coin search, chart, TVL, APY, many bugfix
* [**v1-sdk**](https://github.com/AnimeSwap/v1-sdk) implement APY calculation
