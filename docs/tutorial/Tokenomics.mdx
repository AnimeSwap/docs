...
Currently, AnimeSwap is deployed on [Aptos](https://aptoslabs.com/) and [Sui](https://sui.io/), `ANI` is only circulates on Aptos mainnet currently.
...
|----------------------|----------------|-----------------|--|
| Liquidity Providers Airdrop | 9,216,500 | - | [218,079 ANI not claim has been burned](https://explorer.aptoslabs.com/txn/46993446/events) |
| Early Backers Airdrop | 783,500 | - | [218,079 ANI not claim has been burned](https://explorer.aptoslabs.com/txn/46993446/events) |
...
The main distribution `90%` of emission is [#staking-and-farm](#staking-and-farm)

The rest distribution `10%` of emission is [#dao-treasury](#dao-treasury)
...
* [Airdrop Contract Open source code](https://github.com/AnimeSwap/v1-staking/tree/main/Airdrop)
* [Airdrop Liquidity Providers addresses (total 1001)](https://github.com/AnimeSwap/airdrop/blob/main/LP_snapshot_address.txt)
* [Airdrop Contract address](https://explorer.aptoslabs.com/account/0xf713bbb607b171ef26dd141050b854a8a7270b5a555a0a202abd98e3e5ded9da/resources?network=mainnet)
