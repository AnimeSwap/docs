...
There are many ways of DAO Treasury income: part of swap fee, ecosystem Cooperation, etc.

The ways of allocating DAO treasury are [voted by community members](#vote-and-governance).

The purpose of the DAO Treasury is to help projects grow better, if there are no better allocating usages, the DAO Treasury will repurchase `ANI` and burn.

### Whitelist Eligibility

AnimeSwap will public some free Anime style or Anime IP cooperation NFT, and the whitelist eligibility of mint is based on `ANI` token, including `ANI` in staking and farm.
